...
<div class="container py-4 d-flex justify-content-center">
    <div class="w-100" style="max-width: 720px;">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h4 class="fw-bold mb-1">👤 Ajouter un employé</h4>
                <p class="text-muted mb-0 small">Remplissez les informations du nouvel employé</p>
            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="poste" id="poste"
                                   ...
                                   value="{{ old('poste') }}" placeholder="Ex: Développeur" required>
                            @error('poste')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="department" id="department"
                                   ...
                                   value="{{ old('department') }}" placeholder="Ex: Informatique" required>
                            @error('department')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" name="salaire_base" id="salaire_base"
                                       ...
                                       value="{{ old('salaire_base') }}" placeholder="0.00" required>
