@extends('layouts.app')
@section('title', 'Ajouter une prime')
...
<div class="container py-4 d-flex justify-content-center">
    <div class="w-100" style="max-width: 720px;">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h4 class="fw-bold mb-1">🏆 Ajouter une prime</h4>
                <p class="text-muted mb-0 small">Remplissez les informations de la nouvelle prime</p>
            </div>
