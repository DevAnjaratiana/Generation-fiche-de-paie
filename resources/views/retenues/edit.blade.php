@extends('layouts.app')
@section('title', 'Modifier une retenue')
...
<div class="container py-4 d-flex justify-content-center">
    <div class="w-100" style="max-width: 720px;">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h4 class="fw-bold mb-1">✏️ Modifier une retenue</h4>
                <p class="text-muted mb-0 small">Modifiez les informations de la retenue</p>
            </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-warning text-dark fw-semibold">
                Modifier les informations de la retenue
            </div>
            <div class="card-body p-4">
                <form action="{{ route('retenues.update', $retenue->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                            ...
                            <select name="employee_id" id="employee_id"
                                ...
                                @foreach($employees as $employee)
                                    <option value="{{ $employee->id }}"
                                        {{ old('employee_id', $retenue->employee_id) == $employee->id ? 'selected' : '' }}>
                                        {{ $employee->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="libelle" id="libelle"
                                   ...
                                   value="{{ old('libelle', $retenue->libelle) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" name="montant" id="montant"
                                       ...
                                       value="{{ old('montant', $retenue->montant) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="mois" id="mois"
                                ...
                                @for($i = 1; $i <= 12; $i++)
                                    <option value="{{ $i }}"
                                        {{ old('mois', $retenue->mois) == $i ? 'selected' : '' }}>
